...
as the leading NISQ-era Trotter-based simulation protocol with formally bounded error
scaling, represent the state of the art during precisely the window in which clinically
relevant quantum molecular simulation first becomes computationally tractable.  IBM's own
March 2026 \textit{Science} publication demonstrated SqDRIFT on 100 qubits simulating
32~electrons in C\textsubscript{13}Cl\textsubscript{2}---a benchmark that for the first
